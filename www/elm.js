			...
			case 'Increment':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{count: model.count + 1}),
					$author$project$Main$calculateFibonacci(model.count + 1));
			case 'Decrement':
				return _Utils_Tuple2(
					_Utils_update(
						model,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Elm: ' + ('n = ' + $elm$core$String$fromInt(model.count)))
							])),
						A2(
						$elm$html$Html$span,
						_List_Nil,
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Rust: ' + ('fibonacci(n) = ' + $elm$core$String$fromInt(model.fibonacci)))
							])),
						A2(
						$elm$html$Html$span,
						_List_Nil,
